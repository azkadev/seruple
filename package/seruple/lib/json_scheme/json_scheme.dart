...
class JsonSchemeazkadev {
  /// return original data json
  Map rawData;

  /// return original data json
  JsonSchemeazkadev(this.rawData);
  ...
  /// GeneralUniverse
  static JsonSchemeazkadev empty() {
    return JsonSchemeazkadev({});
  }
...
/// GeneralUniverse
extension JsonSchemeGeneralUniverseExtensions on List<JsonSchemeazkadev> {
  /// GeneralUniverse
  List<Map> toMap() {
    return toJson();
  }
